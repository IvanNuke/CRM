...
function ensureDealRecord(rawDeal) {
    ...
    const record = {
        ...
        is_important: Boolean(src.is_important),
        needs_delivery: Boolean(src.needs_delivery),
...
function buildDealFromTask(task, client, options = {}) {
    ...
    const record = ensureDealRecord({
        ...
        is_important: Boolean(options.is_important),
        needs_delivery: Boolean(options.needs_delivery),
        snooze_count: 0,
        overdue_days: 0,
        followup_step: 1,
